...
export default function PersonalInfoStep2Screen() {
  const router = useRouter();
  const params = useLocalSearchParams();

  const { data, isLoading, isError } = useGetQuestionsQuery({ page: 1, size: 5 });
...
const styles = StyleSheet.create({
  ...
  pillSelected: {
    backgroundColor: "#2C3E50", // Dark slate to match the design (or 34495E)
    borderWidth: 1,
    borderColor: "#2C3E50",
  },
  pillText: {
